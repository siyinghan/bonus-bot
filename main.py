...
def get_daily_bonus():
    ...
    with activate_chrome_driver() as driver:
        ...
        logging.info(f"Chrome driver opened HiFiNi: {hifini_url}")
    ...
    with activate_chrome_driver() as driver:
        ...
        logging.info(f"Chrome driver opened HaiTang: {hai_tang_url}")
    ...
    with activate_chrome_driver() as driver:
        ...
        logging.info(f"Chrome driver opened Baidu Tieba: {baidu_tb_url}")
    ...
    with activate_chrome_driver() as driver:
        ...
        logging.info(f"Chrome driver opened Baidu Baike: {baidu_baike_url}")
